    ...
    for i, coords in enumerate(template_data.get("vertical_lines", [])):
        ...
        if all_distances:
            ...
            if len(filtered):
                ...
                cv2.putText(output, f"{avg_mm:.2f} mm", (x_center + 5, 100),
    ...
    while True:
        ...
        if grab_result.IsValid():
            ...
            if auto:
                ...
                if auto and flg:
                    out=analyze_frame_cv(final_frame, template_data,scale=5)
